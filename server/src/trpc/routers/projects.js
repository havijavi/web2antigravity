...
exports.projectsRouter = (0, trpc_1.router)({
    ...
    create: trpc_1.protectedProcedure
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0: 
                // @ts-ignore
                return [4 /*yield*/, ctx.db.insert(schema_1.projects).values(__assign(__assign({}, input), { userId: 1 }))];
                case 1:
                    // @ts-ignore
                    _c.sent();
    ...
    getById: trpc_1.protectedProcedure
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0: return [4 /*yield*/, ctx.db.query.projects.findFirst({
